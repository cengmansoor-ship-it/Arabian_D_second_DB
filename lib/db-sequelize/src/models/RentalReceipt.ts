...
export class RentalReceipt extends Model<InferAttributes<RentalReceipt>, InferCreationAttributes<RentalReceipt>> {
...
RentalReceipt.init(
  {
    ...
    rentalId: { type: DataTypes.INTEGER, allowNull: false },
  ...
  { sequelize, modelName: "RentalReceipt", tableName: "rental_receipts", timestamps: true },
);
